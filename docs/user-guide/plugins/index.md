...
2.  **Enrich:** The plugin extracts relevant data and attaches it to the entity as **annotations** or **status observations**.
3.  **Visualize:** You use [Custom Content](../custom-content.md) to render this data directly in the `swcat` UI, transforming it into useful insights (tables, links, or status indicators).
...
2.  Collects the generated annotations and status observations.
...
!!! tip
    For details on how to visualize the annotations and status observations generated by plugins, see [Custom Content](../custom-content.md).
