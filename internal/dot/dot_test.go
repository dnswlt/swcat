...
charset="UTF-8"
rankdir="LR"
fontname="Inter,Liberation Sans,Arial"
splines="spline"
class="graphviz-svg"
node[shape="box",fontname="Inter,Liberation Sans,Arial",fontsize="11",style="filled"]
edge[fontname="Inter,Liberation Sans,Arial",fontsize="11",minlen="3"]
