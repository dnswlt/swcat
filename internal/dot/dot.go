...
func (dw *Writer) Start() {
	...
	dw.w.WriteString("fontname=\"Inter,Liberation Sans,Arial\"\n")
	...
	dw.w.WriteString("node[shape=\"box\",fontname=\"Inter,Liberation Sans,Arial\",fontsize=\"11\",style=\"filled\"]\n")
	...
	fmt.Fprintf(dw.w, "edge[fontname=\"Inter,Liberation Sans,Arial\",fontsize=\"11\",minlen=\"%d\"]\n", dw.config.EdgeMinLen)
}
