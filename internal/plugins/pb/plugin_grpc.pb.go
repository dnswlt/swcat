...
const (
	PluginService_Execute_FullMethodName = "/swcat.plugin.v1.PluginService/Execute"
)
...
var PluginService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "swcat.plugin.v1.PluginService",
	...
	Metadata: "swcat/plugin/v1/plugin.proto",
}
